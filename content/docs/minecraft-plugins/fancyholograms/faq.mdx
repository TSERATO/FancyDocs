---
title: FAQ
description: Frequently asked questions for FancyHolograms
---
...
Holograms currently aren't clickable themselves, but [here's](tutorials/clickable-holograms) a workaround
