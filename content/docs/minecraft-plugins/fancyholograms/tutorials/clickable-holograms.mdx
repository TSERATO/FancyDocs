---
title: Clickable Holograms
description: How to make clickable holograms
---
...
2. Install [FancyNpcs](../../fancynpcs/getting-started)
...
7. Add an interaction action to the npc ([action system](../../fancynpcs/tutorials/action-system))