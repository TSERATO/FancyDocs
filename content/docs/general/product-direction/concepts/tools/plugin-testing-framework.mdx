...
description: Pluging testing in a controlled environment
---
...
2. Let a [lightweight minecraft client](lightweight-minecraft-client-sdk.mdx) connect to the server.
3. Run tests
